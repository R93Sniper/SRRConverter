...
#
# Converts all SRM files in the "Input/SRM" Folder and dumps them into "Output". 
# Optionally dumps the output into a text file as well
# ================================================================================================================
...
# ================================================================================================================
def CreateOutputFile(FileName: str, OutputString: str):
...
# ================================================================================================================
def ConvertFileToFBX(GenerateLog: bool, FilesInDirectory: list[Path]):
    ...
    for i in FilesInDirectory:
        ...
        OutputFile = OUTPUT_DIR / f"{i.stem}.fbx"
        ...
        if not OutputScene:
            ...
            CreateOutputFile(LogOutput, LogString)
            continue
...
def ConvertModelFiles():
    ...
    InputSubdir = next((SubPath for SubPath in INPUT_DIR.iterdir() if SubPath.is_dir() and SubPath.name.lower() == "srm"), None)
    ...
    #TODO 1
    ConvertFileToFBX(GenerateLog,FilesInDirectory)
